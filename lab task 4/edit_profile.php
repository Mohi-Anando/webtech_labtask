...
<body>
	...
	?>
		...
		<table border="2" width="100%" style="background-color:wheat ;">
			<tr>
				<td width="25%">
					Account<hr><br>
				...
				<td width="75%">
						...
						<form method="post" action="">
								...
								<legen style="background-color:wheat ;">Date of birth</legen><br>
